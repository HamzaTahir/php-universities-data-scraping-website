          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-xs-12 col-12 
                   form-group">
                <label for="province_name">City Name</label>
            ...
            <div class="row">
              ...
              <input type="hidden" value="Add City" name="operation">
              <input type="submit" value="Add New City" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
              </div>
            </div>
          </div>
        </form>
