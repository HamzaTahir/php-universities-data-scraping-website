  ...
  <main class="page-content">
    <div class="container-fluid">
      ...
      <?php
            ...
            $qry = "SELECT * from contact_us_table";
        ...
        <form action="../Insert_Data/admin_panel_data_db_operations.php" 
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <input type="hidden" value="Contact" name="role">
              <input type="hidden" value="Add Contact" name="operation">
              <input type="submit" value="Add New Contact" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
              </div>
            </div>
          </div>
        </form>
