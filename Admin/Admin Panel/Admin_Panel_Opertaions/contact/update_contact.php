...
$("#show-sidebar").click(function() {
 ...
 function Update_Function(value){
  ...
  name_id = "name_"+value;
  phone_id = "phone_"+value;
  email_id = "email_"+value;
  message_id = "message_"+value;
                         ...
                         method='POST'>
                          ...
                          <td>
                            <textarea type='text' name='message'
                              id='message_".$row["id"]."' disabled='disabled' class='form-control'>".$row["message"]."</textarea>
                          </td>
                          <td>
                            <input id='id_".$row["id"]."'  
                            ...
                            <input id='operation_".$row["id"]."'  
                              type='hidden' value='Update Contact' 
                              name='operation'>
