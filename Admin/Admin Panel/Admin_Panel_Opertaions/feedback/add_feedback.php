  ...
  <main class="page-content">
    <div class="container-fluid">
      <div class="row" style="justify-content: center;">
        <h3>Add Feedback Section</h3>
      </div>
      <div class="row" style="justify-content: center;">
        <h5>Enter Feedback Details</h5>
      </div>
      <?php
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-xs-12 col-12 
                ...
                <input type="text"name="feedback" class="form-control" required="required">
              </div>
            </div>
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-xs-12 col-12 
              ...
              <input type="hidden" value="Add Feedback" name="operation">
              <input type="submit" value="Add New Feedback" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
              </div>
            </div>
          </div>
        </form>
