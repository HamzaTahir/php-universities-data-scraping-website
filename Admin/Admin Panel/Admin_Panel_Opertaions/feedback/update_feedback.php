  ...
  <main class="page-content">
    <div class="container-fluid">
      <div class="row" style="justify-content: center;">
        <h1>Update Subscriber Section</h1>
      </div>
     <!--  <div class="row" style="justify-content: center;">
              ...
              while($row = mysqli_fetch_assoc($result)){
                echo "<tr>
                       <form action='../Insert_Data/admin_panel_data_db_operations.php'
                         ...
                         <td>
                            <textarea name='feedback' id='feedback_".$row["id"]."'disabled='disabled' class='form-control'>".$row["feedback"]."</textarea>
                          </td>
                          <td>
                            <input id='id_".$row["id"]."'  
                            ...
                            <input id='role_".$row["id"]."'  
                              type='hidden' value='Feedback' 
                              name='role'>
                            
                            <input id='operation_".$row["id"]."'  
                              type='hidden' value='Update Feedback' 
                              name='operation'>
