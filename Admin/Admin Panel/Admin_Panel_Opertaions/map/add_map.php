        ...
        <form action="../Insert_Data/admin_panel_data_db_operations.php" 
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <input type="hidden" value="Add Map" name="operation">
              <input type="submit" value="Add New Map" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
              </div>
            </div>
          </div>
        </form>
