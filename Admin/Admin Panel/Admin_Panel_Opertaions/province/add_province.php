 ...
 <main class="page-content">
    <div class="container-fluid">
      <div class="row" style="justify-content: center;">
        <h1>Add Province Section</h1>
      </div>
      <div class="row" style="justify-content: center;">
        <h5>Enter Province Details</h5>
      </div>
      <div class="row">
        <form action="../Insert_Data/admin_panel_data_db_operations.php" 
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <input type="hidden" value="Province" name="role">
              <input type="hidden" value="Add Province" name="operation">
              <input type="submit" value="Add New Province" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
              </div>
            </div>
          </div>
        </form>
