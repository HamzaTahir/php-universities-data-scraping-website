  ...
  <main class="page-content">
    <div class="container-fluid">
      ...
      <?php
            ...
            $qry = "SELECT * from province_table";
                ...
                echo "<tr>
                          ...
                          <td>
                            <form action='../Insert_Data/admin_panel_data_db_operations.php'
                              ...
                              <input type='hidden' value='Delete Province' name='operation'>
                              <input type='submit' value='Delete Province' 
