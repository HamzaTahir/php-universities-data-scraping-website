          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
              <div class="dashboard_small_boxes dashboard_small_boxes_3">
                ...
                <?php
                      $conn=mysqli_connect("localhost","root","","education_host_pk");
                      $qry = "SELECT count(id) as total from province_table";
                      $result = mysqli_query($conn,$qry);
                      $data=mysqli_fetch_assoc($result);
                      echo $data['total'];
                ?>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
              <div class="dashboard_small_boxes dashboard_small_boxes_4">
                ...
                <?php
                      $conn=mysqli_connect("localhost","root","","education_host_pk");
                      $qry = "SELECT count(id) as total from city_table";
                      $result = mysqli_query($conn,$qry);
                      $data=mysqli_fetch_assoc($result);
                      echo $data['total'];
                ?>
         ...
         <div class="row" style="margin-top: 6%;">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
              <div class="dashboard_small_boxes dashboard_small_boxes_5">
                ...
                <?php
                      $conn=mysqli_connect("localhost","root","","education_host_pk");
                      $qry = "SELECT count(id) as total from uni_table";
                      $result = mysqli_query($conn,$qry);
                      $data=mysqli_fetch_assoc($result);
                      echo $data['total'];
                ?>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
              <div class="dashboard_small_boxes dashboard_small_boxes_6">
                ...
                <?php
                      $conn=mysqli_connect("localhost","root","","education_host_pk");
                      $qry = "SELECT count(id) as total from field_table";
                      $result = mysqli_query($conn,$qry);
                      $data=mysqli_fetch_assoc($result);
                      echo $data['total'];
                ?>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
              <div class="dashboard_small_boxes dashboard_small_boxes_7">
                ...
                <?php
                      $conn=mysqli_connect("localhost","root","","education_host_pk");
                      $qry = "SELECT count(id) as total from map_table";
                      $result = mysqli_query($conn,$qry);
                      $data=mysqli_fetch_assoc($result);
                      echo $data['total'];
                ?>
