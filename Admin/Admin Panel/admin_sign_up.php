      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
            <div class="form-wrap">
              <h2 class="mb-4">Sign Up Admin account</h2>
              <form action="new_admin_register.php" method="post">
                <div class="row">
                ...
                <div class="row ">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 form-group">
                    ...
                    <input type="text" name="admin_first_name" class="form-control py-2" required="required">
                  </div>
                </div>
                <div class="row ">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 form-group">
                    <label for="second_name">Second Name</label>
                    <input type="text" name="admin_second_name" class="form-control py-2" required="required">
                  </div>
                </div>
                <div class="row ">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 form-group">
                ...
                <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 form-group" style="text-align: center;">
                    <input type="submit" value="Sign Up" class="btn btn-primary px-5 py-2" style="background-color: #388087;">
                  </div>
                </div>
              </form>
            </div>
