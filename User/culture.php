      ...
      <div class="container">
        <div class="row justify-content-center element-animate">
          <div class="col-md-7 text-center section-heading">
            <h1 class="text-primary heading"  style="color: #388087 !important;">Our Culuture</h1>
          </div>
        </div>
      </div>
      <div>
                            ...
                            <div class='item' style='height:420px;'>
                                <div class='block-19' style='padding:10px;
                                 padding-bottom:5px;'>
                                    ...
                                    elseif (strpos($row["image"], '<img src') !== false && strpos($row["story_image"], 'http') !== false ) {
                                      echo " <p>
                                            ".$row["image"]."
                                        </p>";
                                    }
                                    elseif (strpos($row["image"], 'http') !== false) {
